...
namespace tardigradeHydra {
    ...
    namespace linearElasticity {
        ...
        class residual : public tardigradeHydra::ResidualBase<> {
           ...
           private:
            // Friend classes
            friend class tardigradeHydra::linearElasticity::unit_test::
            ...
            TARDIGRADE_HYDRA_DECLARE_ITERATION_STORAGE(private, dPK2StressdPreviousFe, fourthOrderTensor,
                                                       setdPK2StressdPreviousFe)

            TARDIGRADE_HYDRA_DECLARE_PREVIOUS_STORAGE(private, previousPK2Stress, secondOrderTensor,
                                                      setPreviousPK2Stress)

            TARDIGRADE_HYDRA_DECLARE_PREVIOUS_STORAGE(private, previousdPK2StressdEe, fourthOrderTensor,
                                                      setPreviousdPK2StressdEe)

            TARDIGRADE_HYDRA_DECLARE_PREVIOUS_STORAGE(private, previousdPK2StressdFe, fourthOrderTensor,
                                                      setPreviousdPK2StressdFe)

            TARDIGRADE_HYDRA_DECLARE_ITERATION_STORAGE(private, cauchyStress, secondOrderTensor, setCauchyStress)

            TARDIGRADE_HYDRA_DECLARE_ITERATION_STORAGE(private, dCauchyStressdPK2Stress, fourthOrderTensor,
                                                       setdCauchyStressdPK2Stress)
            ...
            TARDIGRADE_HYDRA_DECLARE_ITERATION_STORAGE(private, dCauchyStressdPreviousF, fourthOrderTensor,
                                                       setdCauchyStressdPreviousF)

            TARDIGRADE_HYDRA_DECLARE_ITERATION_STORAGE(private, dCauchyStressdPreviousFn, floatVector,
                                                       setdCauchyStressdPreviousFn)

            TARDIGRADE_HYDRA_DECLARE_PREVIOUS_STORAGE(private, previousCauchyStress, secondOrderTensor,
                                                      setPreviousCauchyStress)

            TARDIGRADE_HYDRA_DECLARE_PREVIOUS_STORAGE(private, previousdCauchyStressdPK2Stress, fourthOrderTensor,
                                                      setPreviousdCauchyStressdPK2Stress)

            TARDIGRADE_HYDRA_DECLARE_PREVIOUS_STORAGE(private, previousdCauchyStressdF, fourthOrderTensor,
