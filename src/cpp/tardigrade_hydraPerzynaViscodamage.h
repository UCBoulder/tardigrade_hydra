        ...
        class residual : public tardigradeHydra::perzynaViscoplasticity::residual {
           public:
            ...
            residual(tardigradeHydra::hydraBase *hydra, const unsigned int &numEquations,
                ...
                : tardigradeHydra::perzynaViscoplasticity::residual(hydra, numEquations, damageConfigurationIndex,
           ...
           private:
            ...
            TARDIGRADE_HYDRA_DECLARE_ITERATION_STORAGE(private, damageDeformationGradient, floatVector,
                                                       setDamageDeformationGradient)
            ...
            TARDIGRADE_HYDRA_DECLARE_ITERATION_STORAGE(private, dDamagedPreviousCauchyStress, floatVector,
                                                       setAllDamageJacobians)

            TARDIGRADE_HYDRA_DECLARE_ITERATION_STORAGE(private, dDamagedPreviousF, floatVector, setAllDamageJacobians)

            TARDIGRADE_HYDRA_DECLARE_ITERATION_STORAGE(private, dDamagedPreviousSubFs, floatVector,
                                                       setAllDamageJacobians)

            TARDIGRADE_HYDRA_DECLARE_ITERATION_STORAGE(private, dDamagedPreviousT, floatType, setAllDamageJacobians)

            TARDIGRADE_HYDRA_DECLARE_ITERATION_STORAGE(private, dDamagedPreviousStateVariables, floatVector,
                                                       setAllDamageJacobians)

            TARDIGRADE_HYDRA_DECLARE_ITERATION_STORAGE(private, dDamageDeformationGradientdCauchyStress, floatVector,
                                                       setDamageDeformationGradientJacobians)

            TARDIGRADE_HYDRA_DECLARE_ITERATION_STORAGE(private, dDamageDeformationGradientdF, floatVector,
                                                       setDamageDeformationGradientJacobians)

            TARDIGRADE_HYDRA_DECLARE_ITERATION_STORAGE(private, dDamageDeformationGradientdSubFs, floatVector,
                                                       setDamageDeformationGradientJacobians)

            TARDIGRADE_HYDRA_DECLARE_ITERATION_STORAGE(private, dDamageDeformationGradientdT, floatVector,
                                                       setDamageDeformationGradientJacobians)

            TARDIGRADE_HYDRA_DECLARE_ITERATION_STORAGE(private, dDamageDeformationGradientdStateVariables, floatVector,
                                                       setDamageDeformationGradientJacobians)

            TARDIGRADE_HYDRA_DECLARE_ITERATION_STORAGE(private, dDamageDeformationGradientdPreviousCauchyStress,
                                                       floatVector, setAllDamageDeformationGradientJacobians)

            TARDIGRADE_HYDRA_DECLARE_ITERATION_STORAGE(private, dDamageDeformationGradientdPreviousF, floatVector,
                                                       setAllDamageDeformationGradientJacobians)

            TARDIGRADE_HYDRA_DECLARE_ITERATION_STORAGE(private, dDamageDeformationGradientdPreviousSubFs, floatVector,
                                                       setAllDamageDeformationGradientJacobians)

            TARDIGRADE_HYDRA_DECLARE_ITERATION_STORAGE(private, dDamageDeformationGradientdPreviousT, floatVector,
                                                       setAllDamageDeformationGradientJacobians)

            TARDIGRADE_HYDRA_DECLARE_ITERATION_STORAGE(private, dDamageDeformationGradientdPreviousStateVariables,
                                                       floatVector, setAllDamageDeformationGradientJacobians)
        };
