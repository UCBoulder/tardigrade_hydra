...
namespace tardigradeHydra {
    ...
    namespace micromorphicLinearElasticity {
        ...
        class residual : public tardigradeHydra::ResidualBaseMicromorphic<hydraBaseMicromorphic> {
           public:
            residual(hydraBaseMicromorphic *_hydra, const unsigned int &_numEquations, const floatVector &parameters)
                ...
                TARDIGRADE_ERROR_TOOLS_CATCH(extractMaterialParameters(parameters, _Amatrix, _Bmatrix, _Cmatrix,
                                                                       _Dmatrix));
            }
           ...
           protected:
            ...
            using tardigradeHydra::ResidualBaseMicromorphic<hydraBaseMicromorphic>::setAdditionalDerivatives;

            using tardigradeHydra::ResidualBaseMicromorphic<hydraBaseMicromorphic>::setStress;
           ...
           private:
            // Friend classes
            friend class tardigradeHydra::micromorphicLinearElasticity::unit_test::
            ...
            TARDIGRADE_HYDRA_DECLARE_ITERATION_STORAGE(private, dRightCauchyGreendF, floatVector,
                                                       setdRightCauchyGreendF)

            TARDIGRADE_HYDRA_DECLARE_ITERATION_STORAGE(private, dRightCauchyGreendFn, floatVector,
                                                       setdRightCauchyGreendFn)
            ...
            TARDIGRADE_HYDRA_DECLARE_PREVIOUS_STORAGE(private, previousRightCauchyGreen, floatVector,
                                                      setPreviousDeformation)

            TARDIGRADE_HYDRA_DECLARE_PREVIOUS_STORAGE(private, previousdRightCauchyGreendF, floatVector,
                                                      setPreviousdRightCauchyGreendF)

            TARDIGRADE_HYDRA_DECLARE_PREVIOUS_STORAGE(private, previousdRightCauchyGreendFn, floatVector,
                                                      setPreviousdRightCauchyGreendFn)
            ...
            TARDIGRADE_HYDRA_DECLARE_PREVIOUS_STORAGE(private, previousdGammadGradChi, floatVector,
                                                      setPreviousdGammadGradChi)
            ...
            TARDIGRADE_HYDRA_DECLARE_PREVIOUS_STORAGE(private, previousdGammadGradChin, floatVector,
                                                      setPreviousdGammadGradChin)
            ...
            TARDIGRADE_HYDRA_DECLARE_ITERATION_STORAGE(private, referenceSymmetricMicroStress, floatVector,
                                                       setReferenceSymmetricMicroStress)
            ...
            TARDIGRADE_HYDRA_DECLARE_PREVIOUS_STORAGE(private, previousdPK2dGradChi, floatVector,
                                                      setPreviousdPK2dGradChi)

            TARDIGRADE_HYDRA_DECLARE_PREVIOUS_STORAGE(private, previousdPK2dGradChin, floatVector,
                                                      setPreviousdPK2dGradChin)

            TARDIGRADE_HYDRA_DECLARE_PREVIOUS_STORAGE(private, previousReferenceSymmetricMicroStress, floatVector,
                                                      setPreviousReferenceSymmetricMicroStress)
            ...
            TARDIGRADE_HYDRA_DECLARE_PREVIOUS_STORAGE(private, previousdSIGMAdGradChi, floatVector,
                                                      setPreviousdSIGMAdGradChi)

            TARDIGRADE_HYDRA_DECLARE_PREVIOUS_STORAGE(private, previousdSIGMAdGradChin, floatVector,
                                                      setPreviousdSIGMAdGradChin)

            TARDIGRADE_HYDRA_DECLARE_PREVIOUS_STORAGE(private, previousReferenceHigherOrderStress, floatVector,
                                                      setPreviousReferenceHigherOrderStress)
            ...
            TARDIGRADE_HYDRA_DECLARE_ITERATION_STORAGE(private, dCauchyStressdGradChi, floatVector,
                                                       setdCauchyStressdGradChi)

            TARDIGRADE_HYDRA_DECLARE_ITERATION_STORAGE(private, dCauchyStressdGradChin, floatVector,
                                                       setdCauchyStressdGradChin)

            TARDIGRADE_HYDRA_DECLARE_ITERATION_STORAGE(private, symmetricMicroStress, floatVector,
                                                       setSymmetricMicroStress)

            TARDIGRADE_HYDRA_DECLARE_ITERATION_STORAGE(private, dSymmetricMicroStressdF, floatVector,
                                                       setdSymmetricMicroStressdF)

            TARDIGRADE_HYDRA_DECLARE_ITERATION_STORAGE(private, dSymmetricMicroStressdFn, floatVector,
                                                       setdSymmetricMicroStressdFn)

            TARDIGRADE_HYDRA_DECLARE_ITERATION_STORAGE(private, dSymmetricMicroStressdChi, floatVector,
                                                       setdSymmetricMicroStressdChi)

            TARDIGRADE_HYDRA_DECLARE_ITERATION_STORAGE(private, dSymmetricMicroStressdChin, floatVector,
                                                       setdSymmetricMicroStressdChin)

            TARDIGRADE_HYDRA_DECLARE_ITERATION_STORAGE(private, dSymmetricMicroStressdGradChi, floatVector,
                                                       setdSymmetricMicroStressdGradChi)

            TARDIGRADE_HYDRA_DECLARE_ITERATION_STORAGE(private, dSymmetricMicroStressdGradChin, floatVector,
                                                       setdSymmetricMicroStressdGradChin)

            TARDIGRADE_HYDRA_DECLARE_ITERATION_STORAGE(private, higherOrderStress, floatVector, setHigherOrderStress)

            TARDIGRADE_HYDRA_DECLARE_ITERATION_STORAGE(private, dHigherOrderStressdF, floatVector,
                                                       setdHigherOrderStressdF)

            TARDIGRADE_HYDRA_DECLARE_ITERATION_STORAGE(private, dHigherOrderStressdFn, floatVector,
                                                       setdHigherOrderStressdFn)

            TARDIGRADE_HYDRA_DECLARE_ITERATION_STORAGE(private, dHigherOrderStressdChi, floatVector,
                                                       setdHigherOrderStressdChi)

            TARDIGRADE_HYDRA_DECLARE_ITERATION_STORAGE(private, dHigherOrderStressdChin, floatVector,
                                                       setdHigherOrderStressdChin)

            TARDIGRADE_HYDRA_DECLARE_ITERATION_STORAGE(private, dHigherOrderStressdGradChi, floatVector,
                                                       setdHigherOrderStressdGradChi)

            TARDIGRADE_HYDRA_DECLARE_ITERATION_STORAGE(private, dHigherOrderStressdGradChin, floatVector,
                                                       setdHigherOrderStressdGradChin)

            TARDIGRADE_HYDRA_DECLARE_PREVIOUS_STORAGE(private, previousCauchyStress, floatVector,
                                                      setPreviousCauchyStress)

            TARDIGRADE_HYDRA_DECLARE_PREVIOUS_STORAGE(private, previousdCauchyStressdF, floatVector,
                                                      setPreviousdCauchyStressdF)

            TARDIGRADE_HYDRA_DECLARE_PREVIOUS_STORAGE(private, previousdCauchyStressdFn, floatVector,
                                                      setPreviousdCauchyStressdFn)

            TARDIGRADE_HYDRA_DECLARE_PREVIOUS_STORAGE(private, previousdCauchyStressdChi, floatVector,
                                                      setPreviousdCauchyStressdChi)

            TARDIGRADE_HYDRA_DECLARE_PREVIOUS_STORAGE(private, previousdCauchyStressdChin, floatVector,
                                                      setPreviousdCauchyStressdChin)

            TARDIGRADE_HYDRA_DECLARE_PREVIOUS_STORAGE(private, previousdCauchyStressdGradChi, floatVector,
                                                      setPreviousdCauchyStressdGradChi)

            TARDIGRADE_HYDRA_DECLARE_PREVIOUS_STORAGE(private, previousdCauchyStressdGradChin, floatVector,
                                                      setPreviousdCauchyStressdGradChin)

            TARDIGRADE_HYDRA_DECLARE_PREVIOUS_STORAGE(private, previousSymmetricMicroStress, floatVector,
                                                      setPreviousSymmetricMicroStress)

            TARDIGRADE_HYDRA_DECLARE_PREVIOUS_STORAGE(private, previousdSymmetricMicroStressdF, floatVector,
                                                      setPreviousdSymmetricMicroStressdF)

            TARDIGRADE_HYDRA_DECLARE_PREVIOUS_STORAGE(private, previousdSymmetricMicroStressdFn, floatVector,
                                                      setPreviousdSymmetricMicroStressdFn)

            TARDIGRADE_HYDRA_DECLARE_PREVIOUS_STORAGE(private, previousdSymmetricMicroStressdChi, floatVector,
                                                      setPreviousdSymmetricMicroStressdChi)

            TARDIGRADE_HYDRA_DECLARE_PREVIOUS_STORAGE(private, previousdSymmetricMicroStressdChin, floatVector,
                                                      setPreviousdSymmetricMicroStressdChin)

            TARDIGRADE_HYDRA_DECLARE_PREVIOUS_STORAGE(private, previousdSymmetricMicroStressdGradChi, floatVector,
                                                      setPreviousdSymmetricMicroStressdGradChi)

            TARDIGRADE_HYDRA_DECLARE_PREVIOUS_STORAGE(private, previousdSymmetricMicroStressdGradChin, floatVector,
                                                      setPreviousdSymmetricMicroStressdGradChin)

            TARDIGRADE_HYDRA_DECLARE_PREVIOUS_STORAGE(private, previousHigherOrderStress, floatVector,
                                                      setPreviousHigherOrderStress)

            TARDIGRADE_HYDRA_DECLARE_PREVIOUS_STORAGE(private, previousdHigherOrderStressdF, floatVector,
                                                      setPreviousdHigherOrderStressdF)

            TARDIGRADE_HYDRA_DECLARE_PREVIOUS_STORAGE(private, previousdHigherOrderStressdFn, floatVector,
                                                      setPreviousdHigherOrderStressdFn)

            TARDIGRADE_HYDRA_DECLARE_PREVIOUS_STORAGE(private, previousdHigherOrderStressdChi, floatVector,
                                                      setPreviousdHigherOrderStressdChi)

            TARDIGRADE_HYDRA_DECLARE_PREVIOUS_STORAGE(private, previousdHigherOrderStressdChin, floatVector,
                                                      setPreviousdHigherOrderStressdChin)

            TARDIGRADE_HYDRA_DECLARE_PREVIOUS_STORAGE(private, previousdHigherOrderStressdGradChi, floatVector,
                                                      setPreviousdHigherOrderStressdGradChi)

            TARDIGRADE_HYDRA_DECLARE_PREVIOUS_STORAGE(private, previousdHigherOrderStressdGradChin, floatVector,
                                                      setPreviousdHigherOrderStressdGradChin)
        };
...
#include "tardigrade_hydraMicromorphicLinearElasticity.tpp"
