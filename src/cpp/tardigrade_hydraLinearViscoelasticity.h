    ...
    namespace linearViscoelasticity {
        ...
        class residual : public tardigradeHydra::linearElasticity::residual {
           public:
             ...
             * \param &viscoelasticISVLowerIndex: The lower index of the viscoelastic ISVs in the
             * hydra::_additionalStateVariables \param &viscoelasticISVUpperIndex: The upper index (not included) of the
             * viscoelastic ISVs in the hydra::_additionalStateVariables \param &integrationAlpha: The integration alpha
             * parameter (0. is implicit, 1 is explicit)
             */
            residual(tardigradeHydra::hydraBase *hydra, const unsigned int &numEquations, const floatVector &parameters,
                     const unsigned int viscoelasticISVLowerIndex, const unsigned int viscoelasticISVUpperIndex,
                     const floatType integrationAlpha = 0.)
                : tardigradeHydra::linearElasticity::residual(hydra, numEquations),
                  _viscoelasticISVLowerIndex(viscoelasticISVLowerIndex),
                  _viscoelasticISVUpperIndex(viscoelasticISVUpperIndex),
                  _integrationAlpha(integrationAlpha) {
            ...
            //! Get the upper (but not including) index of the viscoelastic ISVs from the non-nonlinear solve state
            //! variable vector
            ...
            virtual void decomposeStateVariableVector(floatVector &volumetricStateVariables,
            ...
            virtual floatVector computedRateMultiplierdVariables(const floatVector &variables,
           ...
           private:
            ...
            floatType
                _integrationAlpha;  //!< The parameter for implicit (0) vs explicit (1) integration. Defaults to 0.
            ...
            floatVector
                _volumetricTemperatureParameters;  //!< The temperature parameters for the volumetric viscous elements

            floatVector
                _isochoricTemperatureParameters;  //!< The temperature parameters for the isochoric viscous elements

            // Friend classes
            friend class tardigradeHydra::linearViscoelasticity::unit_test::
            ...
            TARDIGRADE_HYDRA_DECLARE_PREVIOUS_STORAGE(private, previousJe, floatType,
                                                      decomposePreviousElasticDeformation)

            TARDIGRADE_HYDRA_DECLARE_PREVIOUS_STORAGE(private, previousFehat, secondOrderTensor,
                                                      decomposePreviousElasticDeformation)
            ...
            TARDIGRADE_HYDRA_DECLARE_PREVIOUS_STORAGE(private, previousdFehatdFe, fourthOrderTensor,
                                                      setPreviousdFehatdFe)
            ...
            TARDIGRADE_HYDRA_DECLARE_ITERATION_STORAGE(private, dVolumetricISVsdPreviousT, floatVector,
                                                       setdVolumetricISVsdPreviousT)

            TARDIGRADE_HYDRA_DECLARE_ITERATION_STORAGE(private, dVolumetricISVsdPreviousFe, floatVector,
                                                       setdVolumetricISVsdPreviousFe)

            TARDIGRADE_HYDRA_DECLARE_ITERATION_STORAGE(private, dVolumetricISVsdPreviousISVs, floatVector,
                                                       setdPK2MeanStressdPreviousISVs)

            TARDIGRADE_HYDRA_DECLARE_ITERATION_STORAGE(private, dPK2IsochoricStressdT, secondOrderTensor,
                                                       setdPK2IsochoricStressdT)

            TARDIGRADE_HYDRA_DECLARE_ITERATION_STORAGE(private, dPK2IsochoricStressdFe, secondOrderTensor,
                                                       setdPK2IsochoricStressdFe)

            TARDIGRADE_HYDRA_DECLARE_ITERATION_STORAGE(private, dPK2IsochoricStressdPreviousT, secondOrderTensor,
                                                       setdPK2IsochoricStressdPreviousT)

            TARDIGRADE_HYDRA_DECLARE_ITERATION_STORAGE(private, dPK2IsochoricStressdPreviousFe, fourthOrderTensor,
                                                       setdPK2IsochoricStressdPreviousFe)

            TARDIGRADE_HYDRA_DECLARE_ITERATION_STORAGE(private, dPK2IsochoricStressdPreviousISVs, floatVector,
                                                       setdPK2IsochoricStressdPreviousISVs)
            ...
            TARDIGRADE_HYDRA_DECLARE_ITERATION_STORAGE(private, dIsochoricISVsdPreviousT, floatVector,
                                                       setdIsochoricISVsdPreviousT)

            TARDIGRADE_HYDRA_DECLARE_ITERATION_STORAGE(private, dIsochoricISVsdPreviousFe, floatVector,
                                                       setdIsochoricISVsdPreviousFe)

            TARDIGRADE_HYDRA_DECLARE_ITERATION_STORAGE(private, dIsochoricISVsdPreviousISVs, floatVector,
                                                       setdIsochoricISVsdPreviousISVs)

            TARDIGRADE_HYDRA_DECLARE_ITERATION_STORAGE(private, previousPK2MeanStress, floatType,
                                                       setPreviousPK2MeanStress)

            TARDIGRADE_HYDRA_DECLARE_ITERATION_STORAGE(private, previousPK2IsochoricStress, secondOrderTensor,
                                                       setPreviousPK2IsochoricStress)

            TARDIGRADE_HYDRA_DECLARE_ITERATION_STORAGE(private, previousdPK2MeanStressdT, floatType,
                                                       setPreviousdPK2MeanStressdT)

            TARDIGRADE_HYDRA_DECLARE_ITERATION_STORAGE(private, previousdPK2MeanStressdFe, secondOrderTensor,
                                                       setPreviousdPK2MeanStressdFe)

            TARDIGRADE_HYDRA_DECLARE_ITERATION_STORAGE(private, previousdPK2IsochoricStressdT, secondOrderTensor,
                                                       setPreviousdPK2IsochoricStressdT)

            TARDIGRADE_HYDRA_DECLARE_ITERATION_STORAGE(private, previousdPK2IsochoricStressdFe, fourthOrderTensor,
                                                       setPreviousdPK2IsochoricStressdFe)

            TARDIGRADE_HYDRA_DECLARE_ITERATION_STORAGE(private, dPK2StressdT, secondOrderTensor, setdPK2StressdT)

            TARDIGRADE_HYDRA_DECLARE_ITERATION_STORAGE(private, dPK2StressdPreviousT, secondOrderTensor,
                                                       setdPK2StressdPreviousT)

            TARDIGRADE_HYDRA_DECLARE_ITERATION_STORAGE(private, dPK2StressdPreviousISVs, floatVector,
                                                       setdPK2StressdPreviousISVs)

            TARDIGRADE_HYDRA_DECLARE_PREVIOUS_STORAGE(private, previousdPK2StressdT, secondOrderTensor,
                                                      setPreviousdPK2StressdT)

            TARDIGRADE_HYDRA_DECLARE_ITERATION_STORAGE(private, dCauchyStressdT, secondOrderTensor, setdCauchyStressdT)

            TARDIGRADE_HYDRA_DECLARE_ITERATION_STORAGE(private, dCauchyStressdPreviousT, secondOrderTensor,
                                                       setdCauchyStressdPreviousT)

            TARDIGRADE_HYDRA_DECLARE_ITERATION_STORAGE(private, dCauchyStressdPreviousISVs, floatVector,
                                                       setdCauchyStressdPreviousISVs)

            TARDIGRADE_HYDRA_DECLARE_PREVIOUS_STORAGE(private, previousdCauchyStressdT, secondOrderTensor,
                                                      setPreviousdCauchyStressdT)
        };
