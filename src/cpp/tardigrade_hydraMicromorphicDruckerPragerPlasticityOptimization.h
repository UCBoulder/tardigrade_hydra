        ...
        class residual : public tardigradeHydra::micromorphicDruckerPragerPlasticity::residual {
           public:
            ...
            residual(hydraBaseMicromorphic *_hydra, const unsigned int &_numEquations,
                 ...
                 * function. 0 is explicit, 1 is implicit.
                 */
                ...
                setPenaltyIndices(positive_indices);  //!< The indices of values in the unknown vector which should be
                                                      //!< penalized for being negative
