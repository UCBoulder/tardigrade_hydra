/**
  ******************************************************************************
  * \file tardigrade_hydraHyperElasticityBase.h
  ******************************************************************************
  * An implementation of hyperelasticity using the hydra framework. Defines a
  * simple quadratic energy potential as the basis for more complex models.
  ******************************************************************************
  */

#ifndef TARDIGRADE_HYDRA_HYPERELASTIC_BASE_H
#define TARDIGRADE_HYDRA_HYPERELASTIC_BASE_H
...
namespace tardigradeHydra{
    ...
    namespace hyperelasticBase{
        ...
        /*!
         * A residual base class for hyperelasticity where the stress is computed as the derivative of a eergy potential
         * We implement a quadratic potential as a base
         */
        class residual : public tardigradeHydra::residualBase {
            ...
            public:
                ...
                /*!
                 * The main initialization constructor for the hyperelastic base class
                 * 
