...
namespace tardigradeHydra {
    ...
    namespace massChange {
        ...
        void residual::decomposeAdditionalDOF() {
            ...
            TARDIGRADE_ERROR_TOOLS_CHECK(hydra->getAdditionalDOF()->size() >= 5,
                                         "The additional DOF vector is of size " +
                                             std::to_string(hydra->getAdditionalDOF()->size()) +
                                             " which is less than the required size of 5");

            TARDIGRADE_ERROR_TOOLS_CHECK(hydra->getPreviousAdditionalDOF()->size() >= 5,
                                         "The previous additional DOF vector is of size " +
            ...
            *directionVector.value =
                dimVector(hydra->getAdditionalDOF()->begin() + 2, hydra->getAdditionalDOF()->begin() + 5);
        ...
        void residual::setMassChangeVelocityGradientTraceDerivatives(const bool &isPrevious) {
            ...
            if (isPrevious) {
                ...
                dMassChangeVelocityGradientTracedDensity =
                    get_SetDataStorage_dPreviousMassChangeVelocityGradientTracedPreviousDensity();

                dMassChangeVelocityGradientTracedMassChangeRate =
                    get_SetDataStorage_dPreviousMassChangeVelocityGradientTracedPreviousMassChangeRate();
                ...
                dMassChangeVelocityGradientTracedDensity =
                    get_SetDataStorage_dMassChangeVelocityGradientTracedDensity();

                dMassChangeVelocityGradientTracedMassChangeRate =
                    get_SetDataStorage_dMassChangeVelocityGradientTracedMassChangeRate();
            }
        ...
        void residual::setdMassChangeVelocityGradientTracedDensity() {
            /*!
             * Set the derivative of the mass-change velocity gradient trace \f$ \left( \ell_{\bar{I}\bar{I}}^{A}
             * \right) \f$ w.r.t. the density
             */
        ...
        void residual::setdMassChangeVelocityGradientTracedMassChangeRate() {
            /*!
             * Set the derivative of the mass-change velocity gradient trace \f$ \left( \ell_{\bar{I}\bar{I}}^{A}
             * \right) \f$ w.r.t. the mass change rate
             */
        ...
        void residual::setdPreviousMassChangeVelocityGradientTracedPreviousDensity() {
            /*!
             * Set the derivative of the previous mass-change velocity gradient trace \f$ \left(
             * \ell_{\bar{I}\bar{I}}^{A} \right) \f$ w.r.t. previous density
             */
        ...
        void residual::setdPreviousMassChangeVelocityGradientTracedPreviousMassChangeRate() {
            /*!
             * Set the derivative of the previous mass-change velocity gradient trace \f$ \left(
             * \ell_{\bar{I}\bar{I}}^{A} \right) \f$ w.r.t. the previous mass change rate
             */
        ...
        void residual::setUnitDirectionVectorDerivatives(const bool &isPrevious) {
            ...
            if (isPrevious) {
                ...
                dUnitDirectionVectordDirectionVector =
                    get_SetDataStorage_dPreviousUnitDirectionVectordPreviousDirectionVector();
        ...
        void residual::setMassChangeVelocityGradientDerivatives(const bool &isPrevious) {
            ...
            if (isPrevious) {
                TARDIGRADE_ERROR_TOOLS_CATCH(dVelocityGradientTracedDensity =
                                                 get_dPreviousMassChangeVelocityGradientTracedPreviousDensity())

                TARDIGRADE_ERROR_TOOLS_CATCH(dVelocityGradientTracedMassChangeRate =
                                                 get_dPreviousMassChangeVelocityGradientTracedPreviousMassChangeRate())

                TARDIGRADE_ERROR_TOOLS_CATCH(velocityGradientTrace = get_previousMassChangeVelocityGradientTrace())

                TARDIGRADE_ERROR_TOOLS_CATCH(dUnitDirectionVectordDirectionVector =
                                                 get_dPreviousUnitDirectionVectordPreviousDirectionVector())
                ...
                dVelocityGradientdMassChangeRate =
                    get_SetDataStorage_dPreviousMassChangeVelocityGradientdPreviousMassChangeRate();

                dVelocityGradientdDirectionVector =
                    get_SetDataStorage_dPreviousMassChangeVelocityGradientdPreviousDirectionVector();

            } else {
                TARDIGRADE_ERROR_TOOLS_CATCH(dVelocityGradientTracedDensity =
                                                 get_dMassChangeVelocityGradientTracedDensity())

                TARDIGRADE_ERROR_TOOLS_CATCH(dVelocityGradientTracedMassChangeRate =
                                                 get_dMassChangeVelocityGradientTracedMassChangeRate())

                TARDIGRADE_ERROR_TOOLS_CATCH(velocityGradientTrace = get_massChangeVelocityGradientTrace())

                TARDIGRADE_ERROR_TOOLS_CATCH(dUnitDirectionVectordDirectionVector =
                                                 get_dUnitDirectionVectordDirectionVector())
        ...
        void residual::setPrecedingDeformationGradient(const bool &isPrevious) {
            ...
            if (isPrevious) {
                ...
                *precedingDeformationGradient.value =
                    hydra->deformation->getPreviousPrecedingConfiguration(getMassChangeConfigurationIndex());

            } else {
                auto precedingDeformationGradient = get_SetDataStorage_precedingDeformationGradient();
                *precedingDeformationGradient.value =
                    hydra->deformation->getPrecedingConfiguration(getMassChangeConfigurationIndex());
            }
        }
            ...
            if (isPrevious) {
                ...
                *precedingDeformationGradient.value =
                ...
                TARDIGRADE_ERROR_TOOLS_CATCH(
                    dpFdFs = hydra->deformation->getPrecedingConfigurationJacobian(getMassChangeConfigurationIndex()))
        ...
        void residual::setMassChangeIntermediateVelocityGradientDerivatives(const bool &isPrevious) {
            ...
            if (isPrevious) {
                ...
                TARDIGRADE_ERROR_TOOLS_CATCH(dLdGradC =
                                                 get_dPreviousMassChangeVelocityGradientdPreviousDirectionVector())
                ...
                dILdGradC =
                    get_SetDataStorage_dPreviousMassChangeIntermediateVelocityGradientdPreviousDirectionVector();

                dILdF =
                    get_SetDataStorage_dPreviousMassChangeIntermediateVelocityGradientdPreviousDeformationGradient();

                dILdFn =
                    get_SetDataStorage_dPreviousMassChangeIntermediateVelocityGradientdPreviousSubDeformationGradients();
        ...
        void residual::setMassChangeDeformationGradient() {
            ...
            TARDIGRADE_ERROR_TOOLS_CATCH(tardigradeConstitutiveTools::evolveFExponentialMap(
                hydra->getDeltaTime(), previousMassChangeDeformationGradient, *previousIntermediateVelocityGradient,
                *intermediateVelocityGradient, *massChangeDeformationGradient.value, getIntegrationParameter()))
        }
        ...
        void residual::setMassChangeDeformationGradientDerivatives(const bool &computePrevious) {
            ...
            if (computePrevious) {
                const secondOrderTensor *dLpdRho =
                    get_dPreviousMassChangeIntermediateVelocityGradientdPreviousDensity();

                const secondOrderTensor *dLpdC =
                    get_dPreviousMassChangeIntermediateVelocityGradientdPreviousMassChangeRate();

                const thirdOrderTensor *dLpdGradC =
                    get_dPreviousMassChangeIntermediateVelocityGradientdPreviousDirectionVector();

                const fourthOrderTensor *dLpdF =
                    get_dPreviousMassChangeIntermediateVelocityGradientdPreviousDeformationGradient();

                const floatVector *dLpdFn =
                    get_dPreviousMassChangeIntermediateVelocityGradientdPreviousSubDeformationGradients();
                ...
                TARDIGRADE_ERROR_TOOLS_CATCH(tardigradeConstitutiveTools::evolveFExponentialMap(
                    hydra->getDeltaTime(), previousMassChangeDeformationGradient, *previousIntermediateVelocityGradient,
                    *intermediateVelocityGradient, *massChangeDeformationGradient.value, dFmdL, dFmdFp, dFmdLp,
                ...
                TARDIGRADE_ERROR_TOOLS_CATCH(tardigradeConstitutiveTools::evolveFExponentialMap(
                    hydra->getDeltaTime(), previousMassChangeDeformationGradient, *previousIntermediateVelocityGradient,
                    *intermediateVelocityGradient, *massChangeDeformationGradient.value, dFmdL,
                    getIntegrationParameter()))
            }
        ...
        void residual::setdRdAdditionalDOF() {
            ...
            const thirdOrderTensor *dMassChangeDeformationdDirectionVector =
                get_dMassChangeDeformationGradientdDirectionVector();
        ...
        void residual::decomposeParameters(const floatVector &parameters) {
            ...
            TARDIGRADE_ERROR_TOOLS_CHECK(parameters.size() == 1,
                                         "The parameter vector must have a length of 1 rather than " +
