...
namespace tardigradeHydra {
    ...
    namespace fourierHeatConduction {
        ...
        void residual::decomposeParameterVector(const floatVector &parameters) {
             ...
             *
             * \param &parameters: The paramter vector. Assumed to be a vector of length _expected_parameter_size which
             * defines the conductivity.
             */

            TARDIGRADE_ERROR_TOOLS_CHECK(parameters.size() == get_expectedParameterVectorSize(),
                                         "Parameter vector is expected to have a length of " +
                                             std::to_string(get_expectedParameterVectorSize()) +
                                             " but has a length of " + std::to_string(parameters.size()))
        ...
        void residual::setPreviousTemperatureGradient() {
            /*!
             * Set the previous value of the temperature gradient. It's assumed this is stored in the additional DOF
             * vector
             */
