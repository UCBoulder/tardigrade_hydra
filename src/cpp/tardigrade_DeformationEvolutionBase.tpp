...
namespace tardigradeHydra {
    ...
    void DeformationEvolutionBase<container, size>::computeDeformation(
        const dt_type &dt, const Lt_iterator &Lt_begin, const Lt_iterator &Lt_end, const Ltp1_iterator &Ltp1_begin,
        const Ltp1_iterator &Ltp1_end, const Ft_iterator &Ft_begin, const Ft_iterator &Ft_end, Ftp1_iterator Ftp1_begin,
        ...
        TARDIGRADE_ERROR_TOOLS_CHECK((unsigned int)(Ft_end - Ft_begin) == size * size,
                                     "The size of Ft is " + std::to_string((unsigned int)(Ft_end - Ft_begin)) +
                                         " but it should be " + std::to_string(size * size))

        TARDIGRADE_ERROR_TOOLS_CHECK((unsigned int)(Ftp1_end - Ftp1_begin) == size * size,
                                     "The size of Ftp1 is " + std::to_string((unsigned int)(Ftp1_end - Ftp1_begin)) +
                                         " but it should be " + std::to_string(size * size))
    ...
    void DeformationEvolutionBase<container, size>::computeDeformation_dFtp1dLtp1(
        const dt_type &dt, const Ltp1_iterator &Ltp1_begin, const Ltp1_iterator &Ltp1_end,
        const Ftp1_iterator &Ftp1_begin, const Ftp1_iterator &Ftp1_end, dFtp1dLtp1_iterator dFtp1dLtp1_begin,
        dFtp1dLtp1_iterator dFtp1dLtp1_end) {
        using dFtp1dLtp1_type = typename std::iterator_traits<dFtp1dLtp1_iterator>::value_type;
        using Ltp1_type       = typename std::iterator_traits<Ltp1_iterator>::value_type;

        TARDIGRADE_ERROR_TOOLS_CHECK((unsigned int)(dFtp1dLtp1_end - dFtp1dLtp1_begin) == size * size * size * size,
                                     "The size of dFtp1dLtp1 is " +
                                         std::to_string((unsigned int)(dFtp1dLtp1_end - dFtp1dLtp1_begin)) +
            ...
            for (unsigned int I = 0; I < size; ++I) {
                for (unsigned int a = 0; a < size; ++a) {
                    RHS[size * size * size * i + size * size * I + size * i + a] +=
                        dt * integration_parameter * (*(Ftp1_begin + size * a + I));
                }
            }
        }
    ...
    void DeformationEvolutionBase<container, size>::computeDeformation_dFtp1dLt(
        const dt_type &dt, const Ltp1_iterator &Ltp1_begin, const Ltp1_iterator &Ltp1_end, const Ft_iterator &Ft_begin,
        const Ft_iterator &Ft_end, dFtp1dLt_iterator dFtp1dLt_begin, dFtp1dLt_iterator dFtp1dLt_end) {
        using dFtp1dLt_type = typename std::iterator_traits<dFtp1dLt_iterator>::value_type;
        using Ltp1_type     = typename std::iterator_traits<Ltp1_iterator>::value_type;

        TARDIGRADE_ERROR_TOOLS_CHECK((unsigned int)(dFtp1dLt_end - dFtp1dLt_begin) == size * size * size * size,
                                     "The size of dFtp1dLt is " +
                                         std::to_string((unsigned int)(dFtp1dLt_end - dFtp1dLt_begin)) +
                                         " but should be " + std::to_string(size * size * size * size));
        ...
        for (unsigned int i = 0; i < size; ++i) {
            for (unsigned int I = 0; I < size; ++I) {
                for (unsigned int a = 0; a < size; ++a) {
                    RHS[size * size * size * i + size * size * I + size * i + a] +=
                        dt * (1. - integration_parameter) * (*(Ft_begin + size * a + I));
                }
            }
        }
    ...
    void DeformationEvolutionBase<container, size>::computeDeformation_dFtp1dFt(
        const dt_type &dt, const Ltp1_iterator &Ltp1_begin, const Ltp1_iterator &Ltp1_end, const Lt_iterator &Lt_begin,
        const Lt_iterator &Lt_end, dFtp1dFt_iterator dFtp1dFt_begin, dFtp1dFt_iterator dFtp1dFt_end) {
        using dFtp1dFt_type = typename std::iterator_traits<dFtp1dFt_iterator>::value_type;
        using Ltp1_type     = typename std::iterator_traits<Ltp1_iterator>::value_type;

        TARDIGRADE_ERROR_TOOLS_CHECK((unsigned int)(dFtp1dFt_end - dFtp1dFt_begin) == size * size * size * size,
                                     "The size of dFtp1dFt is " +
                                         std::to_string((unsigned int)(dFtp1dFt_end - dFtp1dFt_begin)) +
                                         " but should be " + std::to_string(size * size * size * size));
            ...
            for (unsigned int I = 0; I < size; ++I) {
                ...
                for (unsigned int a = 0; a < size; ++a) {
                    RHS[size * size * size * i + size * size * I + size * a + I] +=
                        dt * (1. - integration_parameter) * (*(Lt_begin + size * i + a));
                }
            }
        }
