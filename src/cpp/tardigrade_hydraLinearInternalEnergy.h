        ...
        class residual : public tardigradeHydra::ResidualBase<> {
           public:
            ...
            residual(tardigradeHydra::hydraBase *hydra, const unsigned int &numEquations, const floatVector &parameters,
                     const unsigned int expectedParameterVectorSize = 1, const unsigned int internalEnergyIndex = 9)
                ...
                TARDIGRADE_ERROR_TOOLS_CATCH(
                    tardigradeHydra::linearInternalEnergy::residual::decomposeParameterVector(parameters));
            }
           ...
           protected:
            virtual void setSpecificHeatParameters(const floatVector &specificHeatParameters) {
                /*!
           ...
           private:
            // Friend classes
            friend class tardigradeHydra::linearInternalEnergy::unit_test::
            ...
            TARDIGRADE_HYDRA_DECLARE_ITERATION_STORAGE(private, previousInternalEnergy, floatType,
                                                       setPreviousInternalEnergy)
