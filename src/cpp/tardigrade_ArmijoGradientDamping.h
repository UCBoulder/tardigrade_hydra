...
namespace tardigradeHydra {
    ...
    class ArmijoGradientDamping : public StepDampingBase {
       ...
       private:
        ...
        floatType _lsAlpha = 1e-4;  //!< The line-search alpha value i.e., the term by which it is judged that the
                                    //!< line-search is converging
        ...
        DataStorage<floatType>
            _lsResidualNorm;  //!< The reference residual norm for the line-search convergence criteria
        ...
        //
        //            TARDIGRADE_HYDRA_DECLARE_ITERATION_STORAGE( private, residualNorm,       floatType,
        //            setResidualNorm )
        //
        //            TARDIGRADE_HYDRA_DECLARE_ITERATION_STORAGE( private, dResidualNormdX,    floatVector,
        //            setdResidualNormdX )
        //
        //            DataStorage< floatType > _baseResidualNorm; //!< The base value of the norm of the residual
        //
        //            DataStorage< floatVector > _basedResidualNormdX; //!< The base value of the derivative of the norm
        //            of the residual w.r.t. the unknown vector
        //            // END GRADIENT DESCENT FUNCTIONS
    };
