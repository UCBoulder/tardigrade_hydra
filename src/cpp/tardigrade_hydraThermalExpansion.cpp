...
namespace tardigradeHydra {
    ...
    namespace thermalExpansion {
        ...
        void residual::setThermalGreenLagrangeStrain() {
            ...
            TARDIGRADE_ERROR_TOOLS_CATCH(tardigradeConstitutiveTools::quadraticThermalExpansion(
                hydra->getTemperature(), getReferenceTemperature(), *getLinearParameters(), *getQuadraticParameters(),
        ...
        void residual::setResidual() {
            ...
            *residual.value =
                *get_thermalDeformationGradient() -
        ...
        void residual::decomposeParameters(const floatVector &parameters) {
            ...
            if (parameters.size() != expectedSize) {
                ...
                message +=
                    "The thermal strain must be symmetric so only the upper triangular parameters are required.\n";
        ...
        void residual::addParameterizationInfo(std::string &parameterization_info) {
            ...
            ss << "l_33,    The 33 linear thermal expansion coefficient,        none, " << (*getLinearParameters())[8]
               << "\n";
            ss << "q_11, The 11 quadratic thermal expansion coefficient,        none, "
               << (*getQuadraticParameters())[0] << "\n";
            ss << "q_12, The 12 quadratic thermal expansion coefficient,        none, "
               << (*getQuadraticParameters())[1] << "\n";
            ss << "q_13, The 13 quadratic thermal expansion coefficient,        none, "
               << (*getQuadraticParameters())[2] << "\n";
            ss << "q_21, The 21 quadratic thermal expansion coefficient,        none, "
               << (*getQuadraticParameters())[3] << "\n";
            ss << "q_22, The 22 quadratic thermal expansion coefficient,        none, "
               << (*getQuadraticParameters())[4] << "\n";
            ss << "q_23, The 23 quadratic thermal expansion coefficient,        none, "
               << (*getQuadraticParameters())[5] << "\n";
            ss << "q_31, The 31 quadratic thermal expansion coefficient,        none, "
               << (*getQuadraticParameters())[6] << "\n";
            ss << "q_32, The 32 quadratic thermal expansion coefficient,        none, "
               << (*getQuadraticParameters())[7] << "\n";
            ss << "q_33, The 33 quadratic thermal expansion coefficient,        none, "
               << (*getQuadraticParameters())[8] << "\n";
