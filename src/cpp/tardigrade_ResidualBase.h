...
namespace tardigradeHydra {
    ...
    class ResidualBase : public CachingDataBase {
       public:
         ...
         */
        ResidualBase(container *_hydra, const unsigned int &_numEquations)
            : hydra(_hydra), _numEquations(_numEquations) {}
         ...
         */
        ResidualBase(ResidualBase &r)
            : hydra(r.hydra), _numEquations(r.getNumEquations()), _numConstraints(r.getNumConstraints()) {}
        ...
        virtual void setdRdF() {
            ...
            TARDIGRADE_ERROR_TOOLS_CATCH(throw std::logic_error(
                "The derivative of the residual w.r.t. the deformation gradient is not implemented"));
        }
        ...
        virtual void setdRdT() {
            ...
            TARDIGRADE_ERROR_TOOLS_CATCH(
                throw std::logic_error("The derivative of the residual w.r.t. the temperature is not implemented"));
        }
        ...
        virtual void setPreviousStress() {
            ...
            TARDIGRADE_ERROR_TOOLS_CATCH(
                throw std::logic_error("The calculation of the previous stress is not implemented"));
        }
        ...
        virtual void setConstraints() {
            ...
            TARDIGRADE_ERROR_TOOLS_CATCH(
                throw std::logic_error("The calculation of the constraints is not implemented"));
        }
        ...
        virtual void setConstraintJacobians() {
            ...
            TARDIGRADE_ERROR_TOOLS_CATCH(
                throw std::logic_error("The calculation of the constraint jacobians is not implemented"));
        }
        ...
        virtual void suggestInitialIterateValues(std::vector<unsigned int> &indices, std::vector<floatType> &values) {
            /*!
        ...
        virtual void projectSuggestedX(std::vector<floatType> &trialX, const std::vector<floatType> &Xp) {
            /*!
       ...
       private:
        ...
        std::vector<unsigned int>
            _penalty_indices;  //!< The indices of the variables which should be penalized for negative values

        TARDIGRADE_HYDRA_DECLARE_NAMED_ITERATION_STORAGE(private, setResidual, getResidual, residual, floatVector,
                                                         setResidual)

        TARDIGRADE_HYDRA_DECLARE_NAMED_ITERATION_STORAGE(private, setJacobian, getJacobian, jacobian, floatVector,
                                                         setJacobian)
        ...
        TARDIGRADE_HYDRA_DECLARE_NAMED_ITERATION_STORAGE(private, setdRdAdditionalDOF, getdRdAdditionalDOF,
                                                         dRdAdditionalDOF, floatVector, setdRdAdditionalDOF)

        TARDIGRADE_HYDRA_DECLARE_NAMED_ITERATION_STORAGE(private, setAdditionalDerivatives, getAdditionalDerivatives,
                                                         additionalDerivatives, floatVector, setAdditionalDerivatives)

        TARDIGRADE_HYDRA_DECLARE_NAMED_ITERATION_STORAGE(private, setStress, getStress, stress, floatVector, setStress)

        TARDIGRADE_HYDRA_DECLARE_NAMED_ITERATION_STORAGE(private, setPreviousStress, getPreviousStress, previousStress,
                                                         floatVector, setPreviousStress)
        ...
        TARDIGRADE_HYDRA_DECLARE_NAMED_ITERATION_STORAGE(private, setCurrentAdditionalStateVariables,
                                                         getCurrentAdditionalStateVariables,
                                                         currentAdditionalStateVariables, floatVector,
                                                         setCurrentAdditionalStateVariables)
    };
