    ...
    namespace fourierHeatConduction {
        ...
        class residual : public tardigradeHydra::ResidualBase<> {
           public:
             ...
             * \param &temperatureGradientIndex: The index in the additional DOF array where the temperature gradient
             * exists \param &expectedParameterVectorSize: The expected size of the parameter vector (defaults to 1)
            ...
            residual(tardigradeHydra::hydraBase *hydra, const unsigned int &numEquations, const floatVector &parameters,
                     const unsigned int temperatureGradientIndex, const unsigned int expectedParameterVectorSize = 1,
                ...
                TARDIGRADE_ERROR_TOOLS_CATCH(
                    tardigradeHydra::fourierHeatConduction::residual::decomposeParameterVector(parameters));
            }
           ...
           protected:
            virtual void setConductivityParameters(const floatVector &conductivityParameters) {
                /*!
           ...
           private:
            // Friend classes
            friend class tardigradeHydra::fourierHeatConduction::unit_test::
            ...
            TARDIGRADE_HYDRA_DECLARE_CONSTANT_STORAGE(private, previousTemperatureGradient, floatVector,
                                                      setPreviousTemperatureGradient)
            ...
            unsigned int _temperatureGradientIndex;  //!< The index in the additional DOF vector where the temperature
                                                     //!< gradient is located
