...
namespace tardigradeHydra {
    ...
    void LevenbergMarquardtStep::reset() {
        ...
        TARDIGRADE_ERROR_TOOLS_CHECK(dynamic_cast<tardigradeHydra::GradientDamping *>(getDamping()) != nullptr,
                                     "The damping method must be GradientDamping to work with Levenberg-Marquardt");
    ...
    const floatVector *LevenbergMarquardtStep::getFlatNonlinearLHS() {
        ...
        TARDIGRADE_ERROR_TOOLS_CHECK(local_damping != nullptr,
                                     "The damping method must be GradientDamping to work with Levenberg-Marquardt")
