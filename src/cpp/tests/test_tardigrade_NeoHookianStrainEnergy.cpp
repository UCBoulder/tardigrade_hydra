/**
 * \file test_tardigrade_NeoHookianStrainEnergy.cpp
 *
 * Tests for tardigrade_NeoHookianStrainEnergy
 */

#include "tardigrade_NeoHookianStrainEnergy.h"
#include "tardigrade_SetDataStorage.h"

#define BOOST_TEST_MODULE test_tardigrade_NeoHookianStrainEnergy
...
BOOST_AUTO_TEST_CASE(test_NeoHookianStrainEnergy_setStrainEnergy, *boost::unit_test::tolerance(1e-5)) {
    class NeoHookianStrainEnergyMock : public tardigradeHydra::NeoHookianStrainEnergy {
       public:
        using tardigradeHydra::NeoHookianStrainEnergy::NeoHookianStrainEnergy;
    ...
    class hydraBaseMock : public tardigradeHydra::hydraBase {
       public:
        NeoHookianStrainEnergyMock elasticity;

        tardigradeHydra::ResidualBase<tardigradeHydra::hydraBase> remainder;

        unsigned int elasticitySize = 9;

        tardigradeHydra::floatVector elasticity_parameters = {1.23, 3.45};
        ...
        virtual void setResidualClasses() {
            elasticity = NeoHookianStrainEnergyMock(this, elasticitySize, elasticity_parameters);
    ...
    tardigradeHydra::floatType answer = 17399.699681144317;

    tardigradeHydra::floatType previousAnswer = 8.532683258382715;

    NeoHookianStrainEnergyMock R(&hydra, 9, hydra.elasticity_parameters);
