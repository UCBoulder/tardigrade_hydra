...
BOOST_AUTO_TEST_CASE(test_SetDataStorageBase2, *boost::unit_test::tolerance(DEFAULT_TEST_TOLERANCE)) {
    class ResidualMock {
       public:
        ...
        TARDIGRADE_HYDRA_DECLARE_SETDATASTORAGE_GETTER(myVectorData, tardigradeHydra::SetDataStorageBase,
                                                       std::vector<double>);
    };
...

    {
        ...
        *setFloatType.value = 123.4;
        ...
        tardigradeHydra::SetDataStorageBase<std::vector<double> > setVectorType =
            residual.get_SetDataStorage_myVectorData();
...
BOOST_AUTO_TEST_CASE(test_SetDataStorageIteration, *boost::unit_test::tolerance(DEFAULT_TEST_TOLERANCE)) {
    ...
    {
        tardigradeHydra::SetDataStorageIterationBase<ResidualMock, double> setFloatType(&residual.myScalarData,
                                                                                        &residual);

        *setFloatType.value = 123.4;

        tardigradeHydra::SetDataStorageIterationBase<ResidualMock, std::vector<double> > setVectorType(
            &residual.myVectorData, &residual);
    ...
    namespace test_SetDataStorageIteration2 {
        ...
        class ResidualMock {
           public:
            ...
            TARDIGRADE_HYDRA_DECLARE_CONTROLLED_SETDATASTORAGE_GETTER(myScalarData, SetDataStorageIteration, double,
                                                                      this);
