...
typedef tardigradeHydra::fourierHeatConduction::floatVector
    floatVector;  //!< Redefinition of the vector of floating points type
typedef tardigradeHydra::fourierHeatConduction::floatMatrix
...
BOOST_AUTO_TEST_CASE(test_residual_runBasicGetTests, *boost::unit_test::tolerance(DEFAULT_TEST_TOLERANCE)) {
    ...
    tardigradeHydra::hydraBase hydra(dof, deformationGradient, previousDeformationGradient, additionalDOF,
...
BOOST_AUTO_TEST_CASE(test_residual_getTemperatureGradient, *boost::unit_test::tolerance(DEFAULT_TEST_TOLERANCE)) {
    ...
    floatVector additionalDOF = {
        +3.929384e-01, -4.277213e-01, -5.462971e-01, +1.026295e-01, +4.389379e-01, -1.537871e-01, +9.615284e-01,
        +3.696595e-01, -3.813620e-02, -2.157650e-01, -3.136440e-01, +4.580994e-01, -1.228555e-01, -8.806442e-01,
        -2.039115e-01, +4.759908e-01, -6.350165e-01, -6.490965e-01, +6.310275e-02, +6.365517e-02, +2.688019e-01,
        +6.988636e-01, +4.489106e-01, +2.220470e-01, +4.448868e-01, -3.540822e-01, -2.764227e-01, -5.434735e-01,
        -4.125719e-01, +2.619522e-01, -8.157901e-01, -1.325977e-01, -1.382745e-01, -1.262980e-02, -1.483394e-01,
        -3.754776e-01, -1.472974e-01, +7.867783e-01, +8.883200e-01, +3.673352e-03, +2.479059e-01, -7.687632e-01,
        -3.654290e-01, -1.703476e-01, +7.326183e-01, -4.990893e-01, -3.393147e-02, +9.711196e-01, +3.897024e-02,
        +2.257891e-01, -7.587427e-01, +6.526816e-01, +2.061203e-01, +9.013601e-02, -3.144723e-01};

    floatVector previousAdditionalDOF = {
        -3.917584e-01, -1.659556e-01, +3.626015e-01, +7.509137e-01, +2.084467e-02, +3.386276e-01, +1.718731e-01,
        +2.498070e-01, +3.493781e-01, +6.846849e-01, -8.336100e-01, +5.273657e-01, -5.126673e-01, -6.115541e-01,
        +1.449139e-01, -8.085750e-01, +7.706537e-01, +2.544979e-01, +4.468327e-01, -9.677416e-01, +1.888638e-01,
        +1.135704e-01, -6.820807e-01, -6.938590e-01, +3.910591e-01, -3.624671e-01, +3.839406e-01, +1.087665e-01,
        -2.220989e-01, +8.502650e-01, +6.833400e-01, -2.852049e-01, -9.128171e-01, -3.904639e-01, -2.036286e-01,
        +4.099177e-01, +9.907170e-01, -2.881703e-01, +5.250956e-01, +1.863538e-01, +3.834036e-01, -6.977451e-01,
        -2.022474e-01, -5.182882e-01, -3.130880e-01, +2.625631e-02, +3.332491e-01, -7.881830e-01, -7.382101e-01,
        -3.560388e-01, +3.231287e-01, +6.930125e-01, +1.065147e-01, +7.089050e-01, -2.303244e-01};
    ...
    std::vector<double> answer = {-0.41257191, 0.26195225, -0.81579012};

    std::vector<double> previousAnswer = {-0.22209885, 0.85026498, 0.68333999};
...
BOOST_AUTO_TEST_CASE(test_residual_getHeatFlux, *boost::unit_test::tolerance(DEFAULT_TEST_TOLERANCE)) {
    ...
    std::vector<double> answer = {0.10108012, -0.0641783, 0.19986858};

    std::vector<double> previousAnswer = {0.05441422, -0.20831492, -0.1674183};
...

    {
        ...
        for (unsigned int i = 0; i < NUM_VAR; ++i) {
            ...
            tardigradeHydra::hydraBase hydrap(dof, deformationGradient, previousDeformationGradient, x_p,
                                              previousAdditionalDOF, previousStateVariables, parameters,
                                              numConfigurations, numNonLinearSolveStateVariables);

            tardigradeHydra::hydraBase hydram(dof, deformationGradient, previousDeformationGradient, x_m,
                                              previousAdditionalDOF, previousStateVariables, parameters,
                                              numConfigurations, numNonLinearSolveStateVariables);
...
BOOST_AUTO_TEST_CASE(test_residual_getResidual, *boost::unit_test::tolerance(DEFAULT_TEST_TOLERANCE)) {
    ...
    floatVector unknownVector = {
        -3.664242e-01, -2.914706e-01, -6.578363e-01, +6.582253e-01, -3.226583e-01, +1.047402e-01, +1.571029e-01,
        +4.306612e-02, -9.946239e-01, +9.766908e-01, +8.106832e-01, -5.847283e-01, -4.150212e-01, +4.002031e-02,
        +8.038227e-01, +9.672618e-01, -4.849159e-01, +1.287181e-01, +6.139374e-01, -2.112599e-01, +4.621461e-01,
        -6.778620e-01, +2.013971e-01, +1.012700e-01, +2.274211e-01, -8.212532e-01};
    ...
    std::vector<double> answer = {+2.763797e-02, +6.781157e-01, -4.111285e-01};
    ...
    // dRdF
    {
        ...
        for (unsigned int i = 0; i < NUM_VAR; ++i) {
            ...
            tardigradeHydra::hydraBase hydrap(dof, x_p, previousDeformationGradient, additionalDOF,
                                              previousAdditionalDOF, previousStateVariables, parameters,
                                              numConfigurations, numNonLinearSolveStateVariables);

            tardigradeHydra::hydraBase hydram(dof, x_m, previousDeformationGradient, additionalDOF,
                                              previousAdditionalDOF, previousStateVariables, parameters,
                                              numConfigurations, numNonLinearSolveStateVariables);
    ...
    // dRdT
    {
        ...
        for (unsigned int i = 0; i < NUM_VAR; ++i) {
            ...
            tardigradeHydra::DOFStorageBase dofp(time, deltaTime, x_p, previousTemperature);

            tardigradeHydra::DOFStorageBase dofm(time, deltaTime, x_m, previousTemperature);

            tardigradeHydra::hydraBase hydrap(dofp, deformationGradient, previousDeformationGradient, additionalDOF,
                                              previousAdditionalDOF, previousStateVariables, parameters,
                                              numConfigurations, numNonLinearSolveStateVariables);

            tardigradeHydra::hydraBase hydram(dofm, deformationGradient, previousDeformationGradient, additionalDOF,
                                              previousAdditionalDOF, previousStateVariables, parameters,
                                              numConfigurations, numNonLinearSolveStateVariables);
    ...
    // dRdX
    {
        ...
        for (unsigned int i = 0; i < NUM_VAR; ++i) {
            ...
            tardigradeHydra::hydraBase hydrap(dof, deformationGradient, previousDeformationGradient, additionalDOF,
                                              previousAdditionalDOF, previousStateVariables, parameters,
                                              numConfigurations, numNonLinearSolveStateVariables);

            tardigradeHydra::hydraBase hydram(dof, deformationGradient, previousDeformationGradient, additionalDOF,
                                              previousAdditionalDOF, previousStateVariables, parameters,
                                              numConfigurations, numNonLinearSolveStateVariables);
