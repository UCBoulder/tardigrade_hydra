...
BOOST_AUTO_TEST_CASE( test_matrixMap, * boost::unit_test::tolerance( DEFAULT_TEST_TOLERANCE ) ){
    ...
    const std::vector< double > A = {
        +1.000000000e-01,+1.473684211e-01,+1.947368421e-01,+2.421052632e-01,
    ...
    const std::vector< double > B = {
        +1.200000000e+00,+1.227586207e+00,+1.255172414e+00,+1.282758621e+00,
        +1.310344828e+00,+1.337931034e+00,+1.365517241e+00,+1.393103448e+00,
        +1.420689655e+00,+1.448275862e+00,+1.475862069e+00,+1.503448276e+00,
        +1.531034483e+00,+1.558620690e+00,+1.586206897e+00,+1.613793103e+00,
        +1.641379310e+00,+1.668965517e+00,+1.696551724e+00,+1.724137931e+00,
        +1.751724138e+00,+1.779310345e+00,+1.806896552e+00,+1.834482759e+00,
        +1.862068966e+00,+1.889655172e+00,+1.917241379e+00,+1.944827586e+00,
        +1.972413793e+00,+2.000000000e+00
    };

    const std::vector< double > b = {
        +1.200000000e+00,+1.288888889e+00,+1.377777778e+00,+1.466666667e+00,
        +1.555555556e+00,+1.644444444e+00,+1.733333333e+00,+1.822222222e+00,
        +1.911111111e+00,+2.000000000e+00
    };

    std::vector< double > C_answer = {
        +5.247549909e+00,+5.333938294e+00,+5.420326679e+00,+1.269582577e+01,
        +1.291288566e+01,+1.312994555e+01
    };

    std::vector< double > c_answer = {
        +5.357894737e+00,+1.293684211e+01
    };
