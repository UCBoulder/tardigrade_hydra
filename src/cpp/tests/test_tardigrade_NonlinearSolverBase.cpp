...
BOOST_AUTO_TEST_CASE( test_NonlinearSolverBase_callResidualSuccessfulNLStep, * boost::unit_test::tolerance( DEFAULT_TEST_TOLERANCE ) ){
...
BOOST_AUTO_TEST_CASE( test_NonlinearSolverBase_callResidualPreNLSolve, * boost::unit_test::tolerance( DEFAULT_TEST_TOLERANCE ) ){
...
BOOST_AUTO_TEST_CASE( test_NonlinearSolverBase_callResidualPostNLSolve, * boost::unit_test::tolerance( DEFAULT_TEST_TOLERANCE ) ){
...
BOOST_AUTO_TEST_CASE( test_NonlinearSolverBase_setTolerance, * boost::unit_test::tolerance( DEFAULT_TEST_TOLERANCE ) ){
    ...
    tardigradeHydra::floatVector toleranceAnswer = 1e-9 * (tardigradeVectorTools::abs( residual ) + tardigradeVectorTools::abs( unknownVector )) + 1e-9;
