...
BOOST_AUTO_TEST_CASE(test_DeformationBase_setPreviousFirstConfigurationGradients,
    ...
    for (unsigned int i = 0; i < previousDeformationGradient.size(); i++) {
        ...
        tardigradeHydra::hydraBase hydra_p(dofp, model_configuration, numConfigurations,
                                           numNonLinearSolveStateVariables);

        tardigradeHydra::hydraBase hydra_m(dofm, model_configuration, numConfigurations,
                                           numNonLinearSolveStateVariables);
    ...
    for (unsigned int i = 0; i < (numConfigurations - 1) * deformationGradient.size(); i++) {
        ...
        tardigradeHydra::hydraBase hydra_p(dof, model_configurationp, numConfigurations,
                                           numNonLinearSolveStateVariables);

        tardigradeHydra::hydraBase hydra_m(dof, model_configurationm, numConfigurations,
                                           numNonLinearSolveStateVariables);
