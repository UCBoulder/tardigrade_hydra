...
BOOST_AUTO_TEST_CASE(test_PreconditionerBase_formMaxRowPreconditioner,
                     *boost::unit_test::tolerance(DEFAULT_TEST_TOLERANCE)) {
    /*!
     * Boost test of the get-configuration command
     */
    ...
    class MaxRowPreconditionerMock
        : public tardigradeHydra::PreconditionerBase {  // Change the parent class to MaxRowPreconditioner when that
                                                        // exists
